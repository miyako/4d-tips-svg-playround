...
If ($event=On Load:K2:1)
	C_BLOB:C604(TEMPLATE_TEXT)  //logically static
	$path:=Get 4D folder:C485(Current resources folder:K5:16)+"SVG"+Folder separator:K24:12+"text.4dsvg"
	DOCUMENT TO BLOB:C525($path; TEMPLATE_TEXT)
...
Case of 
	: ($event=On Load:K2:1) | ($event=On Resize:K2:27)
		...
		PROCESS 4D TAGS:C816(TEMPLATE_TEXT; $template; $data; $params)
