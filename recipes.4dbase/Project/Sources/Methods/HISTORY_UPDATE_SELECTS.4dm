...
$select:=DOM Find XML element:C864(DOM Find XML element by ID:C1010($dom; "selects"); "selects/select"; $selectObjectIds)
...
For ($i; 1; Size of array:C274($selectObjectIds))
	DOM GET XML ATTRIBUTE BY NAME:C728($selectObjectIds{$i}; "object-id"; $objectId)
