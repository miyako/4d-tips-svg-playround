...
$select:=DOM Find XML element:C864(DOM Find XML element by ID:C1010($dom; "selects"); "selects/select"; $selectObjects)
...
If (Size of array:C274($previousSelectObjects)=$selectedCount)
	...
	For ($i; 1; $selectedCount)
		DOM GET XML ATTRIBUTE BY NAME:C728($selectObjects{$i}; "object-id"; $selectObjectId)
